...
<head>	
  ...
  <link rel="stylesheet" type="text/css" media="all" href="style.css">
   <link rel="shortcut icon" type="image/x-icon" href="Image/Elite Captain Black Shielded.ico" />
    <script type="text/javascript" src="javascripts/QuestionManager_js/jquery-1.9.1.min.js"></script>
  <script type="text/javascript" src="javascripts/QuestionManager_js/jquery.autocomplete.min.js"></script>
  <script type="text/javascript" src="javascipts/QuestionManager_js/currency-autocomplete.js"></script>
						...
						<div class="nav navbar-nav navbar-left">				      	
				      	<li class="dropdown">
					        ...
					        <ul class="dropdown-menu">
					          	...
					          	<li><a href="personInfomationController?command=QuestionBankManager"><img src="Image/user.png" style="width: 20px; height: 20px">Thông tin cá nhân</a><hr width="100%" style="margin: 0"/></li>
				     	...
				     	<li>
				     	 ...
				     	 <p class="navbar-text visible-lg" style="color: #C16D0D" >TRANG CHỦ CỦA BẠN</p>			     					      	
				   	 </div>
					</div>
	...
	<div class="container " id="BlockBody">	
		...
		<div class="col-sm-2 " >
			...
			<div style=";color:#A8A196; border: 0.1px solid #E4DBCF;  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.1); margin-top: 30px; -moz-border-radius-topleft:20px;
				...
				<p style=" background-color:#D2CDBA ;padding: 10px; margin: 0;-moz-border-radius-topleft:20px;
	 			...
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	 			<p style="padding: 10px; margin: 0" class="hover_xam"><img src="Image/housing_contract.png" style="width: 20px; margin-right: 3px"><a href="questionManager" style="text-decoration: none">Quản lý Kho câu hỏi</a> 
	 			</p>	 				
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
