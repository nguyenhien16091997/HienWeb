	...
	<div class="container " id="BlockBody">	
		...
		<p style="font-style: inherit; font-size: 15px; color: #968354">xin chào ${fullNameSession }!</p>	
			...
			<div style="color:#A8A196; border: 0.1px solid #E4DBCF;  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.1); margin-top: 30px; -moz-border-radius-topleft:20px;
				...
				<p style="padding: 10px; margin: 0;-moz-border-radius-topleft:20px;
	 			...
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	 			<p style="background-color:#D2CDBA ;padding: 10px; margin: 0" class="hover_xam" style="text-decoration: none"><img src="Image/password.png" style="height: 20px;width: 20px; margin-right: 3px"><a href="changePasswordController?command=QuestionBankManager" style="text-decoration: none"> Đổi mật khẩu</a> </p>	
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	  ...
	  <div class="col-sm-10" style="height: 400px">  
	    	...
	    	<p style="text-align: center;"><strong><span class="glyphicon glyphicon-pencil" style="margin-right: 5px"></span>Đổi Mật Khẩu</strong></p>
	 		<hr width="100%" align="left" />	
	 		<form class="form" action="changePasswordController?command=QuestionBankManager" method="post">
	 			<div class="row">
	 			...
	 			<div class="form-group" style="padding-left:400px; padding-top:30px">					    
					     <button type="submit" class="btn btn-default" style="background-color: #75efd9; color:#1d09f2" name="command" value="QuestionBankManager">Lưu thay đổi</a></button>
				</div>    
	 		</form>	 		
	    </div>	   	   
	</div>	  
	 ...
	 $(document).ready(function(){
			...
			$("#pwc").focusout(function () {
			        if($("#pwc").val().length < 2 || $("#pwc").val().length > 20){
			...
			$("#pwm1").focusout(function () {
		        if($("#pwm1").val().length < 0 || $("#pwm1").val().length > 20){
