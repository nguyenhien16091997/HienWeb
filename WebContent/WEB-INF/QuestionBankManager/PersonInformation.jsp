...
<body>
	...
	<div class="container " id="BlockBody">	
			...
			<p style="font-style: inherit; font-size: 15px; color: #968354">Xin chào ${fullNameSession }!</p>		
	 		...
	 		<div style="color:#A8A196; border: 0.1px solid #E4DBCF;  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.1); margin-top: 30px; -moz-border-radius-topleft:20px;
				...
				<p style="padding: 10px; margin: 0;-moz-border-radius-topleft:20px;
	 			...
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	 			<p style="background-color:#D2CDBA ;padding: 10px; margin: 0" class="hover_xam" style="text-decoration: none"><img src="Image/user.png" style="height: 20px;width: 20px; margin-right: 3px"><a href="personInfomationController?command=questionManager" style="text-decoration: none"> Thông tin cá nhân</a> </p>	
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	    ...
	    <div class="col-md-5">
	    	<hr width="90%" align="left" />
	    	<div class="form-group" style="margin-top: 20px">
		    	<form action="uploadAvatar?command=questionManager" method="post" enctype="multipart/form-data">
