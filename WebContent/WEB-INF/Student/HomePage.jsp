	...
	<div class="container " id="BlockBody">	
		<div class="col-sm-2 " >
			...
			<div style="border: 0.1px solid #E4DBCF;  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.1); margin-top: 30px; -moz-border-radius-topleft:20px;
	 			...
	 			<p style="padding: 10px; margin: 0;background-color: #E4E0E0; -moz-border-radius-topleft:20px;
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color: #C16D0D" >Nguyen Thanh Phuc</h4>
        </div>
        <div class="modal-body">
        	<form >
        		

			Mã Phòng:  <input type="text" name="password" required />
			<br>
<p style="padding: 10px; margin: 0" class="hover_xam"><img src="Image/housing_contract.png" style="height: 20px;width: 20px; margin-right: 3px"><a href="vaothinhe.jsp" style="text-decoration: none"> Vào thi</a> </p>
			</form>
