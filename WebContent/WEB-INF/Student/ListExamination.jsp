					...
					<div class="col-sm-6 col-xs-9">
						<div class="nav navbar-nav navbar-left">				      	
				     	...
				     	<li>
				     	 ...
				     	 <p class="navbar-text visible-lg" style="color: #C16D0D" >LỊCH THI</p>			     					      	
				   	 </div>
					</div>
	...
	<div class="container " id="BlockBody">	
		<div class="col-sm-2 " >
			...
			<div style="border: 0.1px solid #E4DBCF;  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.1); margin-top: 30px; -moz-border-radius-topleft:20px;
	 			...
	 			<hr style="width: 100%; color: #CEA97C; margin:0">
	 			<p style="padding: 10px; margin: 0; background-color: #E4E0E0" class="hover_xam"><img src="Image/Notication.png" style="height: 20px;width: 20px; margin-right: 3px"><a href="studentSevlet?command=listExamination" style="text-decoration: none"> Lịch thi</a> </p>	
				<hr style="width: 100%; color: #CEA97C; margin:0">
	 			...
	 			<table class="table table-hover table-bordered" style="margin-top: 10px;text-align: center;">
	 				<thead>
						<tr>
						    ...
						    <th style="text-align: center;">Danh sách môn thi</th>					   
					...
					<c:set var="count" value="${count+1 }"></c:set>					
						<tr>							
							...
							<td style="text-align: center"><a target="_blank" href="studentSevlet?command=listExam&examinationID=${examinationID }&classID=${mapUser.get(userNameSession).getClassID() }" style="font-size: 15px; color: #B75A0A ;" ><i><u>danh sách môn thi</u></i></a></td>
